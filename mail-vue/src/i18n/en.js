const en = {
    ...
    apiKeyTitle: 'API Key',
    apiKeyDesc: 'Send email via Open API for scripts or 3rd-party integration. Pass X-API-Key in HTTP Headers.',
    showApiKey: 'Show',
    hideApiKey: 'Hide',
    copyApiKey: 'Copy Key',
    resetApiKeyBtn: 'Reset Key',
    copySuccess: 'Copied successfully',
    resetApiKeyConfirm: 'Existing API Key will immediately become invalid. Are you sure to generate a new key?',
